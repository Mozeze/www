...
function wp_today(){
	...
	if( $histtory_post ){
		foreach( $histtory_post as $post ){
			...
			$h_post .= "<li>在".$h_year."年".$post_month."月".$post_day."日发表了:&nbsp;&nbsp;<a href='".$h_permalink."' title='Permanent Link to ".$h_post_title."'>$h_post_title($h_comments views)</a></li>";
		}
	}
